...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 bg-gradient overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute -top-1/2 left-1/2 transform -translate-x-1/2 w-[800px] h-[800px] bg-purple-500/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-1/2 right-1/2 transform translate-x-1/2 w-[600px] h-[600px] bg-blue-500/20 rounded-full blur-3xl" />
        </div>
      </section>
